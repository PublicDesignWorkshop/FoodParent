module FoodParent {
    export class CreateAdoption implements Command {
        private _tree: Tree;
    ...
    export class DeleteAdoption implements Command {
        private _tree: Tree;
        private _person: Person;
        private _adopt: Adopt;
        private _success: Function;
        ...
        public execute(): any {
            var self: DeleteAdoption = this;
            self._adopt = Model.getAdopts().findWhere({ tree: self._tree.getId(), parent: self._person.getId() });
